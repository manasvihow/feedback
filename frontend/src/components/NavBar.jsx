  ...
  console.log(user);
    return (
        ...
        <div className="fixed w-[100%] z-[1200]">
            <nav className="w-full px-8 py-3 bg-white border-b border-gray-100 shadow-sm">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    {/* Logo/Title - clickable for home */}
                    <div
                        className="text-2xl font-bold text-[#5C2849] tracking-tight cursor-pointer hover:opacity-80 transition-opacity"
                        onClick={onHomeClick}
                    >
                        FeedLoop
                    </div>
